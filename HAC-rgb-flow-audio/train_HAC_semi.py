...
from dataloader_DG_HAC_semi import UnifiedHACDomainSemiDataset, UnifiedSemiDataLoader, create_unified_datasets
...
if __name__ == '__main__':
    ...
    train_group.add_argument('--num_workers', type=int, default=4, help='DataLoader worker count')
    ...
    val_dataset = UnifiedHACDomainSemiDataset(
    ...
    test_dataset = UnifiedHACDomainSemiDataset(
